...
$faq = [
  ...
  <head>
    ...
    <link rel="shortcut icon" href="https://upload.wikimedia.org/wikipedia/commons/2/2d/Google-favicon-2015.png" type="image/png">
    ...
    <div id="app">
      ...
      <header>
        ...
        <div class="top_header">
          <div class="logo">
            <img src="img/Google_2015_logo.svg" alt="Logo Google">
            <h2>Privacy e termini</h2>
          </div>
          <div class="buttons">
            <div class="menu">
              <div v-for="i in 9" class="point"></div>
            </div>
            <img src="https://lh3.googleusercontent.com/ogw/ADGmqu82nAZGDcywFISeWo4AD5EiodGK0pE2GEaxxIr9Cw=s32-c-mo" alt="">
          </div>
        </div>

        <nav class="header_nav">
          <ul>
            <li @click="headerCounter = index" v-for="(element, index) in headerNav" :class="(headerCounter == index)?'active':''"><a href="#">{{element}}</a></li>
          </ul>
        </nav>
      ...
      <footer>
        ...
        <div class="container">
          ...
          <div class="language">
            <img src="img/footer_icon.png" alt="language">
            <select>
